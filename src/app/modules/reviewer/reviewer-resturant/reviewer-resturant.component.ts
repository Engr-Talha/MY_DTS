...
@Component({
  selector: 'app-reviewer-resturant',
  templateUrl: './reviewer-resturant.component.html',
  styleUrls: ['./reviewer-resturant.component.scss'],
})
export class ReviewerResturantComponent {
