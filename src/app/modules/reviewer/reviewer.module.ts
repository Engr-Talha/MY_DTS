...
@NgModule({
  declarations: [ReviewerAppListingComponent, ReviewerUserApplicationComponent, ReviewerResturantComponent, ReviewerTravelagencyComponent, ReviewerHotelComponent],
  imports: [
    CommonModule,
