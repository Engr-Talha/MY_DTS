...
@Component({
  selector: 'app-controller-hotel',
  templateUrl: './controller-hotel.component.html',
  styleUrls: ['./controller-hotel.component.scss'],
})
export class ControllerHotelComponent {
