...
@Component({
  selector: 'app-controller-resturnat',
  templateUrl: './controller-resturnat.component.html',
  styleUrls: ['./controller-resturnat.component.scss'],
})
export class ControllerResturnatComponent {
