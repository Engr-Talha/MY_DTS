...
@Component({
  selector: 'app-inspector-travel-agency',
  templateUrl: './inspector-travel-agency.component.html',
  styleUrls: ['./inspector-travel-agency.component.scss'],
})
export class InspectorTravelAgencyComponent {
