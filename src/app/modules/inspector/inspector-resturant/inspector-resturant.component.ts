...
@Component({
  selector: 'app-inspector-resturant',
  templateUrl: './inspector-resturant.component.html',
  styleUrls: ['./inspector-resturant.component.scss'],
})
export class InspectorResturantComponent {
