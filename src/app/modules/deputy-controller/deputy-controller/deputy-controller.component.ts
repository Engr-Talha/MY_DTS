...
@Component({
  selector: 'app-deputy-controller',
  templateUrl: './deputy-controller.component.html',
  styleUrls: ['./deputy-controller.component.scss'],
})
export class DeputyControllerComponent {
