...
@Component({
  selector: 'app-deputy-cont-travel-agency',
  templateUrl: './deputy-cont-travel-agency.component.html',
  styleUrls: ['./deputy-cont-travel-agency.component.scss'],
})
export class DeputyContTravelAgencyComponent {
