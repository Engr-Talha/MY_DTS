...
@Component({
  selector: 'app-assistant-controller-travel-agenct',
  templateUrl: './assistant-controller-travel-agenct.component.html',
  styleUrls: ['./assistant-controller-travel-agenct.component.scss'],
})
export class AssistantControllerTravelAgenctComponent {
      ...
      (res) => {
        ...
        if (rolestobeSent == 1) {
          this.showSuccess(
            ...
            'User Application Approved, sent to the Inspector for further checking.',
          );
