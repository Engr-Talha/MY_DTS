...
@Component({
  selector: 'app-assitant-controller-hotel',
  templateUrl: './assitant-controller-hotel.component.html',
  styleUrls: ['./assitant-controller-hotel.component.scss'],
})
export class AssitantControllerHotelComponent {
