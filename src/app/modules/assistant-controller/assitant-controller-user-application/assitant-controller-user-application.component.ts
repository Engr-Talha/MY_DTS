...
@Component({
  selector: 'app-assitant-controller-user-application',
  templateUrl: './assitant-controller-user-application.component.html',
  styleUrls: ['./assitant-controller-user-application.component.scss'],
})
export class AssitantControllerUserApplicationComponent {
