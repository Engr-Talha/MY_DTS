...
@Component({
  selector: 'app-assistant-controller-resturant',
  templateUrl: './assistant-controller-resturant.component.html',
  styleUrls: ['./assistant-controller-resturant.component.scss'],
})
export class AssistantControllerResturantComponent {
