...
@Component({
  selector: 'app-resturant-application',
  templateUrl: './resturant-application.component.html',
  styleUrls: ['./resturant-application.component.scss'],
})
export class ResturantApplicationComponent {
