...
@Component({
  selector: 'app-tourist-guide-application',
  templateUrl: './tourist-guide-application.component.html',
  styleUrls: ['./tourist-guide-application.component.scss'],
})
export class TouristGuideApplicationComponent {
