...
@Component({
  selector: 'app-hotel-application',
  templateUrl: './hotel-application.component.html',
  styleUrls: ['./hotel-application.component.scss'],
})
export class HotelApplicationComponent {
  ...
  getApplicationbyID(id: any) {
    this.UserApplicationService.getHotelByID(id).subscribe(
      (res: any) => {
        ...
        console.log('====================================');
        console.log('selected application in hotel block ', this.SelectedApplication);
        console.log('====================================');
      },
      (err: any) => {
